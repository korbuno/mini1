		...
		<div class="content row">
			<div class="container">
				<center>
					...
					<form method="post" action="${pageContext.request.contextPath}/jsp/fileGallary/modifyfilegallary?homepage_no=${homepage_no}&category_group_no=${category_group_no}&category_no=${category_no}&no=${board.no}"
					...
					<a href="${pageContext.request.contextPath}/jsp/filegallary/listfilegallary
					?homepage_no=${homepage_no}
					&category_group_no=${category_group_no}
					&category_no=${category_no}">목록</a>
					<a href="${pageContext.request.contextPath}/jsp/filegallary/deletefilegallary
					?homepage_no=${homepage_no}
					&category_group_no=${category_group_no}
					&category_no=${category_no}
					&no=${board.no}">삭제</a>
