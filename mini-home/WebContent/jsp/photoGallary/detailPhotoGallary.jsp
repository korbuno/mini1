				...
				<center>
					<p class="h1">사진첩</p>
						...
						<tbody>
							...
							<tr>
								<c:forEach var = "s" items="${fileList}" varStatus="loop">
								<td><img src="${pageContext.request.contextPath}/common/down?sName=${s.systemName}&dName=${s.oriName}&filePath=${s.filePath}" 
							...
							<tr>
								...
								<td colspan="2" ><span class="label label-primary"> ${likeCount}</span></td>
						...
						<a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/jsp/photogallary/listphotogallary?homepage_no=${homepage_no}&category_group_no=${category_group_no}&category_no=${category_no}">목록</a>
						<a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}
						/jsp/photogallary/modifyformphotogallary
						?homepage_no=${homepage_no}
						&category_group_no=${category_group_no}
						&category_no=${category_no}
						&no=${board.no}
						&member_no=${member_no}
						&commentPageNo=1">수정</a>
						<a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/jsp/photogallary/deletephotogallary?homepage_no=${homepage_no}&category_group_no=${category_group_no}&category_no=${category_no}&no=${board.no}">삭제</a>
						<br>
						
					
						<form method="post" action="${pageContext.request.contextPath}/jsp/photogallary/writecomment?homepage_no=${homepage_no}&category_group_no=${category_group_no}&category_no=${category_no}&no=${board.no}&member_no=${member_no}">
						...
						<table>
							...
							<c:forEach var = "s" items="${commentList}" varStatus="loop">
								<tr>
									...
									<c:choose>
										<c:when test="${commentNo != s.commentNo}">
											<td><a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/jsp/photogallary/detailphotogallary
											?homepage_no=${homepage_no}
											&category_group_no=${category_group_no}
											&category_no=${category_no}
											&no=${s.no}
									...
									<td><a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/jsp/photogallary/deletecomment
									?homepage_no=${homepage_no}
									&category_group_no=${category_group_no}
									&category_no=${category_no}
									&no=${board.no}
