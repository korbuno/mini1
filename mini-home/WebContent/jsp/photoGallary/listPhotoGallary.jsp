...
<body>
		...
		<div class="content row">
			<div class="container">
				<center>
					...
					onclick="move(${homepage_no}, ${category_group_no}, ${category_no}, 'writeformphotogallary')">
					글쓰기
					</a>
					</div>
					<div class="btn btn-default">
					<a style="cursor: pointer;" 
					onclick="move(${homepage_no}, ${category_group_no}, ${category_no}, 'listphotogallarycategory')">
					뒤로
					</a>
					</div>								
								</center>
	...
	<script type="text/javascript">
 		...
 		function detail(homepageNo, categoryGrpNo, 
			...
			var url = "${pageContext.request.contextPath}/jsp/photogallary/detailphotogallary?homepage_no=" 
