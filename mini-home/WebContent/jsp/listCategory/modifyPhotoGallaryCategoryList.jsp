		...
		<div class="content row">
			<div class="container">
				<center>
					...
					<form method="post" action="${pageContext.request.contextPath}/jsp/photogallary/writephotogallarycategory
					...
					<tbody>
						...
						<tr>
							...
							<c:choose>
								...
								<td><a href="${pageContext.request.contextPath}
								/jsp/photogallary/deletephotogallarycategory
								?homepage_no=${homepage_no}
				...
				<a href="${pageContext.request.contextPath}/jsp/photogallary/listphotogallarycategory?homepage_no=${homepage_no}&category_group_no=${category_group_no}">카테고리 목록으로</a>
			</center>                                           
			</div>
		</div>
