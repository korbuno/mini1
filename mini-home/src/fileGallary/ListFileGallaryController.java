...
@WebServlet("/jsp/filegallary/listfilegallary")
public class ListFileGallaryController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String servletPath = "/jsp/filegallary/listfilegallary"
			...
			RequestDispatcher rd = 
					request.getRequestDispatcher(
							"/jsp/fileGallary/listFileGallary.jsp"
					);
