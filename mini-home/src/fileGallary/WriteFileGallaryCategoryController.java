...
@WebServlet("/jsp/fileGallary/writefilegallarycategory")
public class WriteFileGallaryCategoryController extends HttpServlet {
	@Override
	protected void service(HttpServletRequest request,	HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = 
				request.getRequestDispatcher(
						"/jsp/filegallary/listfilegallarycategory"
				);
