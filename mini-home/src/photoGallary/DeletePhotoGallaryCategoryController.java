...
@WebServlet("/jsp/photogallary/deletephotogallarycategory")
public class DeletePhotoGallaryCategoryController extends HttpServlet {
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher(
				"/jsp/listCategory/listPhotoCategory.jsp"	
			);
