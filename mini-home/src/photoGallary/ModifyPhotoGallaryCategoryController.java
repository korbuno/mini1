...
@WebServlet("/jsp/photogallary/modifyphotogallarycategory")
public class ModifyPhotoGallaryCategoryController extends HttpServlet {
	@Override
	protected void service(HttpServletRequest request,	HttpServletResponse response) throws ServletException, IOException {
		...
		// 페이지 이동
		//response.sendRedirect(request.getContextPath() + "/jsp/photogallary/detailPhotoGallary?no=" + request.getParameter("no"));
		RequestDispatcher rd = request.getRequestDispatcher(
				"/jsp/photogallary/detailphotogallary?no=" + request.getParameter("no")
			);
